local function createUI()
    ...
    SpeedLabel.Position = UDim2.new(0.5, -150, 0.2, 0)
    ...
    SpeedInput.Position = UDim2.new(0.5, -20, 0.2, 0)
    ...
    LocalItemsButton.Position = UDim2.new(0.05, 0, 0.3, 0)
    ...
    ESPButton.Position = UDim2.new(0.05, 0, 0.5, 0)
